...
int32_t nvmWriteAppInterface(nvmAppInterface *AppInterface, uint8_t *pkt, uint32_t PktLen, void *userData, char * errbuf)
{
	...
	ts.sec = 0;
	ts.usec = 0;
	return nvmWriteAppInterfaceTS(AppInterface, pkt, PktLen, &ts, userData, errbuf);
}

int32_t nvmWriteAppInterfaceTS(nvmAppInterface *AppInterface, uint8_t *pkt, uint32_t PktLen, nvmTStamp *tstamp, void *userData, char * errbuf)
{
